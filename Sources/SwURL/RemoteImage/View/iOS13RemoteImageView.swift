...
struct iOS13RemoteImageView: SwURLImageViewType {
    ...
    mutating func imageProcessing<ProcessedImage>(_ processing: @escaping (Image) -> ProcessedImage) -> iOS13RemoteImageView where ProcessedImage : View {
    ...
    mutating func progress<T>(_ progress: @escaping (CGFloat) -> T) -> iOS13RemoteImageView where T : View {
